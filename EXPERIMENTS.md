...
**Notebook:** `notebooks/02_model_training_validation.ipynb`

**?????? ??? ??????????? ??????:** `src/analyze_prediction_results.py`
...
**????????:** ?????? ???????? ??? ?????????? ranking ????????????, ??? ?????? ????????????? ??????? ???????? ??? ????????. ????????? ??????? ??????????????? ??? `raspi4` ?? `pixel3`, ???? ?? ??? `eyeriss`, `fpga` ?? `edgetpu` ????????????? ???????????. ?? ???????, ?? ?????? ????? ????????? ???????? ?????????????? ? ????? ??????? hardware-????????, ??? ??? ???????? ????????????? ?? ????????? ??? ?????????? ????????. ????????? ????????? ?????? ???????? ? `docs/prediction_result_analysis.md`.
